...
public class Config {
    ...
    private final static String PAGE_MODE_AUTOREAD_KEY = "pagemodeautoread";
    private final static String PAGE_MODE_READ_SPEED_KEY = "pagemodereadspeed";
    ...
    public final static boolean DEFAULT_AUTOREAD = false;
    public final static int DEFAULT_AUTO_READ_SPEED = 15;
    ...
    public void setAutoRead(boolean autoRead){
        sp.edit().putBoolean(PAGE_MODE_AUTOREAD_KEY,autoRead).commit();
    }

    public boolean getAutoRead(){
        return sp.getBoolean(PAGE_MODE_AUTOREAD_KEY,DEFAULT_AUTOREAD);
    }

    public void setAutoReadSpeed(int speed){
        sp.edit().putInt(PAGE_MODE_READ_SPEED_KEY,speed).commit();
    }

    public int getAutoReadSpeed(){
        return sp.getInt(PAGE_MODE_READ_SPEED_KEY,DEFAULT_AUTO_READ_SPEED);
    }
