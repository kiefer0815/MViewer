...
public enum HttpStatus {
     ...
     * 添加类操作失败
     */
    CLIENT_POST_ERROR(440, "Client Post Error"),
    /**
     * 查询类操作失败
     */
    CLIENT_GET_ERROR(441, "Client Get Error"),

    // --- 43x 自定义 CRM登陆信息
    /**
     * 未登录
     */
    NOT_LOGIN(431, "Not LoginActivity"),
    /**
     * 无权限
     */
    NO_PERMISSION(432, "No Permission"),
    /**
     * 第一次访问
     */
    FIRST_LOGIN(433, "First LoginActivity"),

    Label_Count_Error(434,"LabelCount Error"),
     ...
     * 服务器异常
     */
    SERVER_ERROR(520, "Server error"),


    USERNAME_PWD_WRONG(801,"Username or pwd wrong"),
