...
import com.flyersoft.moonreader.view.DragGridListener;
import com.flyersoft.moonreader.view.DragGridView;
...
public class ShelfAdapter extends BaseAdapter implements DragGridListener {
    ...
    public View getView(int position, View contentView, ViewGroup arg2) {
        ...
        if(bilist.size() > position){
            ...
            if(!TextUtils.isEmpty(bilist.get(position).getStatus())  && bilist.get(position).getStatus().equals("1")){
    ...
    public void updateBookPosition (int position,int databaseId,List<BookList> bookLists) {
        ...
        bookList.setStatus(bookLists.get(position).getStatus());
